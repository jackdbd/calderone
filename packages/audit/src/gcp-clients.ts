...
const debug = makeDebug('audit/gcp-clients')
...
export const gcpClients = async ({
  ...
  let workflow_executions: ExecutionsClient
  ...
  if (isOnCloudRun(env)) {
    ...
    workflow_executions = new ExecutionsClient()
